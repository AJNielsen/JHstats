...
{
    public class TwitterSampleDataRetrieverTests
    {
        private TwitterSampleDataRetriever _twitterSampleDataRetriever;
        ...
        public TwitterSampleDataRetrieverTests()
        {
            _mockTwitterDataStorage = new Mock<ITwitterDataStorage>();
            _twitterSampleDataRetriever = new TwitterSampleDataRetriever(_mockTwitterDataStorage.Object);
        ...
        public void GetStatsReturnsAnEmptyTwitterStatsDetailsWhenThereIsNoTweetData()
        {
            ...
            TwitterStatsDetails twitterStatsDetails = _twitterSampleDataRetriever.GetStats();
        ...
        public void GetStatsReturnsTop10Domains()
        {
            ...
            Assert.Equal(domainOneValue, keyValues[0].Value);

            Assert.Equal(domainTwo, keyValues[1].Key);
            Assert.Equal(domainTwoValue, keyValues[1].Value);

            Assert.Equal(domainThree, keyValues[2].Key);
            Assert.Equal(domainThreeValue, keyValues[2].Value);

            Assert.Equal(domainFour, keyValues[3].Key);
            Assert.Equal(domainFourValue, keyValues[3].Value);

            Assert.Equal(domainFive, keyValues[4].Key);
            Assert.Equal(domainFiveValue, keyValues[4].Value);

            Assert.Equal(domainSix, keyValues[5].Key);
            Assert.Equal(domainSixValue, keyValues[5].Value);

            Assert.Equal(domainSeven, keyValues[6].Key);
            Assert.Equal(domainSevenValue, keyValues[6].Value);

            Assert.Equal(domainEight, keyValues[7].Key);
            Assert.Equal(domainEightValue, keyValues[7].Value);

            Assert.Equal(domainNine, keyValues[8].Key);
            Assert.Equal(domainNineValue, keyValues[8].Value);

            Assert.Equal(domainTen, keyValues[9].Key);
            Assert.Equal(domainTenValue, keyValues[9].Value);
        }
        ...
        public void GetStatsReturnsTop10Emojis()
        {
            ...
            Assert.Equal(emojiOneValue, keyValues[0].Value);

            Assert.Equal(emojiTwo, keyValues[1].Key);
            Assert.Equal(emojiTwoValue, keyValues[1].Value);

            Assert.Equal(emojiThree, keyValues[2].Key);
            Assert.Equal(emojiThreeValue, keyValues[2].Value);

            Assert.Equal(emojiFour, keyValues[3].Key);
            Assert.Equal(emojiFourValue, keyValues[3].Value);

            Assert.Equal(emojiFive, keyValues[4].Key);
            Assert.Equal(emojiFiveValue, keyValues[4].Value);

            Assert.Equal(emojiSix, keyValues[5].Key);
            Assert.Equal(emojiSixValue, keyValues[5].Value);

            Assert.Equal(emojiSeven, keyValues[6].Key);
            Assert.Equal(emojiSevenValue, keyValues[6].Value);

            Assert.Equal(emojiEight, keyValues[7].Key);
            Assert.Equal(emojiEightValue, keyValues[7].Value);

            Assert.Equal(emojiNine, keyValues[8].Key);
            Assert.Equal(emojiNineValue, keyValues[8].Value);

            Assert.Equal(emojiTen, keyValues[9].Key);
            Assert.Equal(emojiTenValue, keyValues[9].Value);
        }
        ...
        public void GetStatsReturnsTotalTweets()
        {
            ...
            Assert.NotNull(twitterStatsDetails);
            Assert.Equal(200, twitterStatsDetails.TotalTweets);
        }
        ...
        public void GetStatsReturnsAveragesOfTweetTimesForSeconds()
        {
            ...
            double expectedAverage = Math.Round((secondOne + secondTwo + secondThree + secondFour + secondFive * 1d) / 5, 2);
        ...
        public void GetStatsReturnsAveragesOfTweetTimesForMinutes()
        {
            ...
            double expectedAverage = Math.Round((minuteOne + minuteTwo + minuteThree + minuteFour + minuteFive * 1d) / 5, 2);
        ...
        public void GetStatsReturnsAveragesOfTweetTimesForHours()
        {
            ...
            double expectedAverage = Math.Round((hourOne + hourTwo + hourThree + hourFour + hourFive * 1d) / 5, 2);
